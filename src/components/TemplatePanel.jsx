            ...
            <button
              ...
              <div className="h-20 flex items-center justify-center relative overflow-hidden"
                ...
                <div className="flex flex-col items-center gap-1.5 opacity-70">
                  <div className="h-2 rounded-full" style={{ width: 40, background: thumb.accent, filter: 'blur(1px)' }} />
                  <div className="h-5 rounded font-black text-xs flex items-center" style={{ color: '#fff', fontFamily: 'Syne', letterSpacing: '-0.02em' }}>
                    50K
                  </div>
                  <div className="h-1.5 rounded-full opacity-40" style={{ width: 32, background: '#fff' }} />
                </div>
                {active && (
                  <div className="absolute top-1.5 right-1.5 w-4 h-4 rounded-full flex items-center justify-center text-white"
                    style={{ background: color1, fontSize: 8 }}>✓</div>
                )}
              </div>
